    ...
    <div class="flex flex-col h-screen bg-slate-950 text-slate-100 font-sans overflow-hidden">
        ...
        >
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800/80 border border-slate-700/60 text-xs">
        ...
        <main class="flex-1 flex overflow-hidden p-4 gap-4 bg-slate-950">
            ...
            <section class="flex-1 flex flex-col min-w-0 bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-xl">
                <ChatArea class="flex-1 h-full" />
            </section>

            <!-- Right Workspace: Sidebar Inspector (Documents & Summaries) -->
            <aside class="w-[380px] lg:w-[440px] flex flex-col shrink-0 bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-xl">
                <!-- Tab Controls -->
                <div class="flex border-b border-slate-800 bg-slate-900/50 p-1.5 gap-1.5 shrink-0">
                    ...
                    >
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6207.293 7.293 1.414 1.414 0 011.414 0L15 6.414 21 12 15z" />
